    ...
    <>
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              <span className="block font-bold text-orange-500 text-4xl lg:text-5xl">Selamat Datang!</span>
              <h1 className="text-base font-semibold text-pertama md:text-xl">
                Terima kasih atas kunjungan Anda ke portofolio saya
              </h1>
              <h2 className="font-medium text-dark mb-4">
                <span className="text-kedua lg:text-2xl">Febrian Syahroni</span>
              </h2>
              <p className="font-medium text-dark mb-10 leading-relaxed">
                ...
                <br />
                <br />
                Di sisi back-end, saya memanfaatkan Node.js dan Express untuk membangun server yang mampu mengelola registrasi pengguna, autentikasi, serta pengelolaan konten kelas. Saya juga mengintegrasikan basis data PostGresSQL untuk menyimpan informasi pengguna, konten kursus, dan data kemajuan.
              </p>
            </div>
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-10 lg:w-1/2">
              <h4 className="font-bold uppercase text-pertama text-lg mb-3">Tentang Saya</h4>
              <h2 className="font-bold text-3xl text-dark mb-5 max-w-md lg:text-4xl">Freshgraduate di <Link href="https://www.rakamin.com/" className="hover:text-green-700 text-kedua" target="_blank">Rakamin.com</Link></h2>
              <p className="font-medium text-base text-dark max-w-xl lg:text-lg">
                Pendidikan saya di Rakamin.com telah memberi saya landasan yang kokoh dalam pemrograman dan pengembangan web. Saya telah berhasil menyelesaikan berbagai proyek yang melibatkan penggunaan teknologi frontend dan backend terkini. Saya terampil dalam merancang antarmuka pengguna yang menarik dan responsif menggunakan HTML, CSS, dan JavaScript. Di sisi server, saya telah menguasai penggunaan database dan bahasa pemrograman seperti Node.js dan Python untuk memastikan fungsionalitas yang mulus.
              </p>
            </div>
            <div className="w-full px-4 lg:w-1/2 lg:pt-10">
              ...
              <div className="flex items-center">
                ...
                {/* Email */}
                <Link href="#footer" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-dark text-dark hover:bg-pertama hover:text-white">
                ...
                {/* Whatsapp */}
                <Link href="#" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-dark text-dark hover:bg-pertama hover:text-white">
        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              <h4 className="font-bold uppercase text-pertama text-lg mb-3">Portfolio</h4>
      ...
      <section id="hubungi kami" className="pt-36 pb-32">
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              <h4 className="font-bold uppercase text-pertama text-lg mb-3">Kontak</h4>
