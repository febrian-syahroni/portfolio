          ...
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              <h2 className="font-medium text-dark mb-4">
                <span className="text-kedua lg:text-2xl">Fullstack Web Developer</span>
              </h2>
              ...
              <Link href="#" className="text-base font-semibold text-white bg-pertama py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Hubungi Kami</Link>
            </div>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2 lg:pt-10">
              ...
              <div className="flex items-center">
                ...
                {/* Email */}
                <Link href="#" target="_blank" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-dark text-dark hover:bg-pertama hover:text-white">
